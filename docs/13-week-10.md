...
* Download the <a href="James Holmes_Expt 2_DATA.csv" download>James Holmes_Expt 2_DATA.csv</a> and save it in your Week 10 folder. Make sure that you do not change the file name at all. * Delete the default R Markdown welcome text and insert a new code chunk that loads `pwr`, `lsr`, `car`, `broom`, `ez`, `emmeans` and `tidyverse` using the `library()` function and loads the data into an object named `dat` using `read_csv()`. If you are working on your own machine you may need to install `afex` and `emmeans` but as always **do not install packages on university machines**.
...
<img src="13-week-10_files/figure-html/violin-plot-1.png" alt="Number of intrusions by condition" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="13-week-10_files/figure-html/bar-plot-1.png" alt="Bar plot of instrusions by condition" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="13-week-10_files/figure-html/fig-qq-1.png" alt="qq-plot for model residuals" width="100%" />
