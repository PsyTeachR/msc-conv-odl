...
* Download <a href="messy.csv" download>messy.csv</a>and save it in your Week 7 folder. Make sure that you do not change the file name at all.  
...
<img src="10-week-7_files/figure-html/img-scale-1.png" alt="Boxplots of scale scores" width="100%" />
