...
* Download <a href="ahi-cesd.csv" download>`ahi-cesd.csv`</a> and `participant-info.csv` <a href="participant-info.csv" download>`participant-info.csv`</a> into your Revision 2 folder.  
* Open R and ensure the environment is clear.
* Set the working directory to your Revision 2 folder.  
* Open a new R Markdown document and save it in your working directory. Call the file "Revision 2".    
