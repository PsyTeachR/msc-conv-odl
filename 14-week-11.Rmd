...
* Delete the default R Markdown welcome text and insert a new code chunk that loads `pwr`, `rcompanion`, `lsr`, `car`, `broom`, `afex`, `emmeans` and `tidyverse` using the `library()` function.
